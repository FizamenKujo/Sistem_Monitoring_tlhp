...
<div class="max-w-xl mx-auto">
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h2 class="text-xl font-bold text-gray-900">Edit Auditi</h2>
            <p class="text-sm text-gray-500 font-medium">Ubah data objek pemeriksaan.</p>
        </div>
    ...
    <div class="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100">
        <form method="POST" action="{{ route('auditi.update', $auditi) }}" class="space-y-6">
            @csrf 
            @method('PUT')
            ...
            <div>
                ...
                <input id="nama" name="nama" type="text" value="{{ old('nama', $auditi->nama) }}" required
            ...
            <div>
                ...
                <input id="kecamatan" name="kecamatan" type="text" value="{{ old('kecamatan', $auditi->kecamatan) }}"
                    class="block w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600 focus:bg-white transition-all">
            </div>
            ...
            <div>
                ...
                <input id="penanggung_jawab" name="penanggung_jawab" type="text" value="{{ old('penanggung_jawab', $auditi->penanggung_jawab) }}"
                    class="block w-full px-4 py-2.5 bg-gray-50 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600 focus:bg-white transition-all">
            </div>
